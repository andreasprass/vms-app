<div class="w-full relative min-h-screen flex" 
    ...
    <div 
        ...
        class="z-50 absolute h-full w-4/6 p-8 flex flex-col justify-between shadow-lg bg-blue-900 text-white text-bold sm:w-3/6 md:w-3/12 md:static md:min-h-screen xl:w-1/6">
        <div>
            ...
            <div class="flex flex-col gap-3">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex flex-col">
                                    <div class="flex items-center">
                                        ...
                                        {{-- <p class="font-semibold text-blue-900 me-2">30 </p><x-heroicon-o-arrow-long-right class="w-4 h-4"/> --}}
                                    </div>
                                    <div class="text-slate-400">
                ...
                <div class="flex flex-col gap-3">
                    <div class="flex justify-between items-center">
                        ...
                        <button class="ps-3 pt-2 pe-3 pb-2 text-white flex items-center bg-blue-900 rounded-full"><h3 class="text-xs">Export </h3> <x-heroicon-o-arrow-down-on-square  class="w-4 h-4"/></button>
                    </div>
